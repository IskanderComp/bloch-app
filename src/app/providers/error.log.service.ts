...
export class ErrorLogService {
  ...
  public logError(error: any): void {
    ...
    // Examples of online logging services
  ...
  private sendToNewRelic( error: any ) : void {
    ...
    new-relic-browser/browser-agent-apis/+
    report-data-events-browser-agent-api
    newrelic.noticeError( error );
  }

  // Send the error to the Raygun error logging service.
  private sendToRaygun( error: any ) : void {
    // Read more: https://raygun.com/raygun-providers/javascript
    Raygun.send( error );
  }

  // Send the error to the Rollbar error logging service.
  private sendToRollbar( error: any ) : void {
    // Read more: https://rollbar.com/docs/notifier/rollbar.js/api/
    Rollbar.error( error );
  }

  // Send the error to the Track.js error logging service.
    ...
    this.http
      ...
      .subscribe(
        ...
        ( httpError: any ) : void => {
          ...
          // ability to accept POST requests on GitHub dashboard-wev-view.
          // --
